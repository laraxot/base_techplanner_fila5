...
Note: Using configuration file /var/www/_bases/base_techplanner_fila4_mono/laravel/phpstan.neon.
 ...
 ------ ----------------------------------------------------------------------- 
  ...
  44     Variable $result in PHPDoc tag @var does not exist.                    
 ...
 ------ ----------------------------------------------------------------------- 
  34     Cannot call method all() on array<Modules\Cms\Datas\BlockData>.        
         🪪  method.nonObject                                                   
         ✏️  Cms/app/Models/Traits/HasBlocks.php                                
  34     Method Modules\Cms\Models\Section::getBlocks() should return array<in  
         t, Modules\Cms\Datas\BlockData> but returns mixed.                     
         🪪  return.type                                                        
         ✏️  Cms/app/Models/Traits/HasBlocks.php                                
  51     Method Modules\Cms\Models\Section::compile() should return array<stri  
 ...
 ------ ------------------------------------------------------------------- 
  32     Method Modules\Cms\View\Composers\ThemeComposer::getMenu() should  
