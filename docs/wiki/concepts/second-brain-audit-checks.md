...
- **pre-push**: `git lfs ls-files` + `find *~cc6378f*` → [git-lfs-and-pub-theme-prevention.md](git-lfs-and-pub-theme-prevention.md)
- **FO theme**: `XotData::make()->pub_theme` must be `Two` for TechPlanner → [pub_theme rule](../../../docs/pub_theme_namespace_rule.md)
