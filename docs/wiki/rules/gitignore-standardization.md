...
Questo documento descrive la standardizzazione del file `.gitignore` per la cartella `bashscripts` del progetto base_<nome progetto>_fila5_mono.
...
- [Template .gitignore](/var/www/_bases/base_<nome progetto>_fila5_mono/bashscripts/.gitignore)
- [Documentazione Git](/var/www/_bases/base_<nome progetto>_fila5_mono/docs/git-best-practices.md)
- [Standardizzazione Moduli](/var/www/_bases/base_<nome progetto>_fila5_mono/laravel/Modules/.gitignore_template)
...
*Questo documento fa parte del processo di standardizzazione del progetto base_<nome progetto>_fila5_mono.*