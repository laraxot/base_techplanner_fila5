...
issues:
  - "https://github.com/laraxot/<owner-repo>/issues/N"
discussions:
  - "https://github.com/laraxot/<owner-repo>/discussions/N"
related:
  - "./relative-path-to-other.md"
---
```

Canon esteso: [wiki-markdown-frontmatter-mandatory.md](./wiki-markdown-frontmatter-mandatory.md). Validazione: `bashscripts/tools/validate-wiki-frontmatter.sh`.
