---
trigger: always_on
description: Regole per l'implementazione del componente FullCalendar di Saade per Filament in Laraxot PTVX
globs: ["**/Filament/Widgets/*Calendar*.php", "**/Models/Evento.php"]
---

# Regole per il Componente FullCalendar in Laraxot PTVX
...
1. `Modules/UI/docs/components/full-calendar.md` (componente base)
2. `Modules/ModuleName/docs/features/full-calendar.md` (implementazione specifica)
...
- [Documentazione Modulo UI](../../laravel/Modules/UI/docs/components/full-calendar.md)
- [Documentazione Modulo Ptv](../../laravel/Modules/Ptv/docs/features/full-calendar.md)
