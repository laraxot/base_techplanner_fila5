...
Prima di implementare story che creano classi in `Modules/*`:

- [bmad-laraxot-implementation-guardrails.md](../concepts/bmad-laraxot-implementation-guardrails.md)
- Memoria incidente: [incident-nwidart-class-outside-app.md](../memories/incident-nwidart-class-outside-app.md) (es. `GenerateTicketsJsonAction` fuori da `app/` — 2026-05-28)
