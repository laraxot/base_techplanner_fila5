...
> **Module/Theme:** Job
> **Scope:** Job-specific knowledge only
> **Created:** 2026-04-15
> **Based on:** Karpathy's LLM Wiki pattern

## Role

You are the **Job Wiki Maintainer**. Your job is to:
...
- Concept is unique to Job
- Pattern is Job-specific
- Decision only affects Job
