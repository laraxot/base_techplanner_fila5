...
> **Heavy work off the request.** Queues, batches, retries — fast UX under load.
...
Scale **without fear** — async done right.
...
**Module** `job` · **Laraxot** · **FixCity Platform** · PHPStan 10 · Filament 5
