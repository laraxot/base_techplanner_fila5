...
return [
    'navigation' => [
        'name' => 'Esportazione',
        'plural' => 'Esportazioni',
        'group' => ['name' => 'Sistema', 'description' => 'Gestione delle esportazioni di dati'],
        'label' => 'Esportazione Dati',
        'sort' => 97,
        'icon' => 'job-export',
    ],
    'fields' => [
        'name' => ['label' => 'Nome', 'tooltip' => 'Inserisci il nome dell\'esportazione', 'placeholder' => 'Esporta i tuoi dati', 'helper_text' => '', 'description' => ''],
        'format' => ['label' => 'Formato', 'tooltip' => 'Scegli il formato di esportazione (CSV, Excel, etc.]', 'placeholder' => 'Seleziona formato', 'helper_text' => '', 'description' => ''],
        'filters' => ['label' => 'Filtri', 'tooltip' => 'Applica filtri per selezionare i dati da esportare', 'placeholder' => 'Filtra i dati', 'helper_text' => '', 'description' => ''],
        'columns' => ['label' => 'Colonne', 'tooltip' => 'Seleziona le colonne da includere nell\'esportazione', 'placeholder' => 'Seleziona colonne', 'helper_text' => '', 'description' => ''],
        'total_records' => ['label' => 'Totale Record', 'tooltip' => 'Numero totale di record da esportare', 'placeholder' => 'Totale', 'helper_text' => '', 'description' => ''],
        'status' => ['label' => 'Stato', 'tooltip' => 'Stato dell\'esportazione', 'placeholder' => 'Stato in corso', 'helper_text' => '', 'description' => ''],
        'created_at' => ['label' => 'Creato il', 'tooltip' => 'Data di creazione dell\'esportazione', 'placeholder' => 'Data di creazione', 'helper_text' => '', 'description' => ''],
        'completed_at' => ['label' => 'Completato il', 'tooltip' => 'Data di completamento dell\'esportazione', 'placeholder' => 'Data di completamento', 'helper_text' => '', 'description' => ''],
        'download_url' => ['label' => 'URL Download', 'tooltip' => 'URL per scaricare il file esportato', 'placeholder' => 'URL del file', 'helper_text' => '', 'description' => ''],
        'source' => ['label' => 'Sorgente', 'tooltip' => 'Origine dei dati per l\'esportazione', 'placeholder' => 'Seleziona la sorgente', 'helper_text' => '', 'description' => ''],
    ...
    'actions' => [
        'create' => ['label' => 'Nuova Esportazione', 'icon' => 'plus', 'color' => 'success', 'tooltip' => 'Crea una nuova esportazione di dati'],
...
>>>>>>> laraxot/dev
    ...
    'types' => ['csv' => 'CSV', 'excel' => 'Excel', 'json' => 'JSON', 'xml' => 'XML', 'pdf' => 'PDF'],
    'label' => 'Export',
