...
return [
    ...
    'navigation' => [
        ...
        'group' => ['name' => 'Sistema', 'description' => 'Gestione e recupero dei jobs falliti'],
    ...
    'model' => [
        'label' => 'Job Fallito',
        'plural' => ['label' => 'Jobs Falliti'],
    ],
    'fields' => [
        'id' => ['label' => 'ID', 'tooltip' => '', 'helper_text' => '', 'description' => ''],
        'uuid' => ['label' => 'UUID', 'tooltip' => '', 'helper_text' => '', 'description' => ''],
        'connection' => ['label' => 'Connessione', 'tooltip' => '', 'helper_text' => '', 'description' => ''],
        'queue' => ['label' => 'Coda', 'tooltip' => '', 'helper_text' => '', 'description' => ''],
        'payload' => ['label' => 'Payload', 'tooltip' => '', 'helper_text' => '', 'description' => ''],
        'exception' => ['label' => 'Eccezione', 'tooltip' => '', 'helper_text' => '', 'description' => ''],
        'failed_at' => ['label' => 'Fallito il', 'tooltip' => '', 'helper_text' => '', 'description' => ''],
        'attempts' => ['label' => 'Tentativi', 'tooltip' => '', 'helper_text' => '', 'description' => ''],
        'max_attempts' => ['label' => 'Tentativi Massimi', 'tooltip' => '', 'helper_text' => '', 'description' => ''],
    ...
    'actions' => [
        'retry' => [
            'label' => 'Riprova',
            'modal' => ['heading' => 'Riprova Job', 'description' => 'Vuoi riprovare ad eseguire questo job?'],
            'messages' => ['success' => 'Job riavviato con successo', 'error' => 'Errore durante il riavvio del job'],
        ],
        'retry_all' => [
            'label' => 'Riprova Tutti',
            'modal' => ['heading' => 'Riprova Tutti i Jobs', 'description' => 'Vuoi riprovare tutti i jobs falliti?'],
            'messages' => ['success' => 'Jobs riavviati con successo', 'error' => 'Errore durante il riavvio dei jobs'],
        ],
        'delete' => [
            'label' => 'Elimina',
        ...
        'delete_all' => [
            'label' => 'Elimina Tutti',
            'modal' => ['heading' => 'Elimina Tutti i Jobs', 'description' => 'Sei sicuro di voler eliminare tutti i jobs falliti?'],
            'messages' => ['success' => 'Jobs eliminati con successo', 'error' => 'Errore durante l\'eliminazione dei jobs'],
        ],
        'clear' => [
            'label' => 'Pulisci Tutto',
