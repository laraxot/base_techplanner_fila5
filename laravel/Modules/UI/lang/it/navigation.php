...
'navigation' => [
    ...
    'actions' => [
        'create' => [
            ...
            'failure' => 'Errore nella creazione della navigazione',
        ],
        'edit' => [
            'label' => 'Modifica Navigazione',
            'success' => 'Navigazione aggiornata con successo',
            'failure' => 'Errore nell\'aggiornamento della navigazione',
        ],
        'delete' => [
            'label' => 'Elimina Navigazione',
