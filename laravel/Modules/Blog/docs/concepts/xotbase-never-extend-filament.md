---
title: "Blog — mai Filament\*, sempre XotBase*"
type: concept
module: Blog
tags: [blog, filament, xotbase, architecture]
created: 2026-07-16
updated: 2026-07-16
qmd: "Blog filament never extend Filament class XotBase mirror path"
related:
...
Nessuna classe in `Modules/Blog` estende una classe `Filament\...` direttamente.
