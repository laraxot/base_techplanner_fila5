# Module Root Hygiene — Why the Blog Module Root Stays Clean
...
- **Copy-paste module bootstrapping.** New modules are cloned from a sibling and
  ...
  The `scripts/ci/contributor-lines-report.mjs` in this module is the same file
  shipped byte-for-byte into AI and Comment — clear evidence of template drift.
