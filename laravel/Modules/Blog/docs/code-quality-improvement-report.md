---
title: "Code Quality Improvement Report — Blog"
type: report
tags: [code-quality, phpstan, pest, maintainability]
module: "Blog"
created: 2026-07-17
updated: 2026-07-17
qmd: "code quality baseline PHPStan Pest strict types Laraxot Blog"
story: STORY-001
issues:
...
# Code Quality Improvement Report — Blog
...
| Indicatore | Valore |
|---|---:|
| File PHP applicativi/database/route | 327 |
| File di test PHP | 0 |
| Rapporto test/file PHP | 0% |
| Candidati senza strict types | 233 |
...
1. **app/resources_to_delete/views/components/menu/v1.blade.php — strict types e firme.** Inserire declare(strict_types=1) subito dopo l’apertura PHP; eseguire PHPStan e sostituire i tipi impliciti o mixed emersi con tipi concreti. Verifica: PHPStan scoped e test che esercita la prima API pubblica del file.
...
6. **app/resources_to_delete — duplicati dichiarati da eliminare.** Verificare con rg che nessun provider li carichi, poi cancellare la directory e mantenere una sola copia delle view sotto resources/views; il file top_users_volume.blade.php oggi esiste in entrambe.
