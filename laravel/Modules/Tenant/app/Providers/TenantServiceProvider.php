...
class TenantServiceProvider extends XotBaseServiceProvider
{
    ...
    public function registerDB(): void
    {
        ...
        /** @var array<string, array<mixed>|float|int|string|null> $data */
        $data = is_array($raw) ? $raw : [];

        /** @var array<string, array<mixed>|float|int|string|null> $connections */
        $connections = [];
        ...
        /** @var array<mixed>|float|int|string|null $connectionsRaw */
