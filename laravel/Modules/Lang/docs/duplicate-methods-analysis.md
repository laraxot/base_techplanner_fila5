...
Questo documento identifica i metodi duplicati nel modulo **Lang** che potrebbero beneficiare di refactoring.
...
**Tipo Refactoring**: `Interface` | **Complessità**: 🟢 Low | **Confidenza**: ✅ 100%

**Trovato in  file2 file**:

- `Post::linkable` - [Modules/Lang/app/Models/Post.php:183](Modules/Lang/app/Models/Post.php)
- `NotifyTheme::linkable` - [Modules/Notify/app/Models/NotifyTheme.php:179](Modules/Notify/app/Models/NotifyTheme.php) (Modulo: Notify)
...
- `TransArrayAction::trans` - [Modules/Lang/app/Actions/TransArrayAction.php:44](Modules/Lang/app/Actions/TransArrayAction.php)
- `TransCollectionAction::trans` - [Modules/Lang/app/Actions/TransCollectionAction.php:43](Modules/Lang/app/Actions/TransCollectionAction.php)
- `TenantService::trans` - [Modules/Tenant/app/Services/TenantService.php:347](Modules/Tenant/app/Services/TenantService.php) (Modulo: Tenant)
...
- `TranslationFile::getRows` - [Modules/Lang/app/Models/TranslationFile.php:100](Modules/Lang/app/Models/TranslationFile.php)
...
- `BaseModel::casts` - [Modules/Lang/app/Models/BaseModel.php:63](Modules/Lang/app/Models/BaseModel.php)
- `BaseModelLang::casts` - [Modules/Lang/app/Models/BaseModelLang.php:71](Modules/Lang/app/Models/BaseModelLang.php)
- `BaseMorphPivot::casts` - [Modules/Lang/app/Models/BaseMorphPivot.php:55](Modules/Lang/app/Models/BaseMorphPivot.php)
- `Post::casts` - [Modules/Lang/app/Models/Post.php:292](Modules/Lang/app/Models/Post.php)
- `TranslationFile::casts` - [Modules/Lang/app/Models/TranslationFile.php:90](Modules/Lang/app/Models/TranslationFile.php)
...
- `TranslatorService::get` - [Modules/Lang/app/Services/TranslatorService.php:28](Modules/Lang/app/Services/TranslatorService.php)
...
- `MetatagService::get` - [Modules/Seo/app/Services/MetatagService.php:30](Modules/Seo/app/Services/MetatagService.php) (Modulo: Seo)
...
- `GetAllModuleTranslationAction::execute` - [Modules/Lang/app/Actions/GetAllModuleTranslationAction.php:20](Modules/Lang/app/Actions/GetAllModuleTranslationAction.php)
- `GetAllTranslationAction::execute` - [Modules/Lang/app/Actions/GetAllTranslationAction.php:20](Modules/Lang/app/Actions/GetAllTranslationAction.php)
- `GetTransPathAction::execute` - [Modules/Lang/app/Actions/GetTransPathAction.php:20](Modules/Lang/app/Actions/GetTransPathAction.php)
- `PublishTranslationAction::execute` - [Modules/Lang/app/Actions/PublishTranslationAction.php:21](Modules/Lang/app/Actions/PublishTranslationAction.php)
- `ReadTranslationFileAction::execute` - [Modules/Lang/app/Actions/ReadTranslationFileAction.php:22](Modules/Lang/app/Actions/ReadTranslationFileAction.php)
- `SaveTransAction::execute` - [Modules/Lang/app/Actions/SaveTransAction.php:21](Modules/Lang/app/Actions/SaveTransAction.php)
- `SyncTranslationsAction::execute` - [Modules/Lang/app/Actions/SyncTranslationsAction.php:23](Modules/Lang/app/Actions/SyncTranslationsAction.php)
- `TransArrayAction::execute` - [Modules/Lang/app/Actions/TransArrayAction.php:25](Modules/Lang/app/Actions/TransArrayAction.php)
- `TransCollectionAction::execute` - [Modules/Lang/app/Actions/TransCollectionAction.php:26](Modules/Lang/app/Actions/TransCollectionAction.php)
- `WriteTranslationFileAction::execute` - [Modules/Lang/app/Actions/WriteTranslationFileAction.php:29](Modules/Lang/app/Actions/WriteTranslationFileAction.php)
