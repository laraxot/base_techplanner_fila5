...
**Html2Pdf** è una libreria PHP per convertire HTML in PDF, utilizzata in Laraxot per generare documenti PDF da template Blade. Basata su TCPDF, supporta PHP 7.2-8.4.
