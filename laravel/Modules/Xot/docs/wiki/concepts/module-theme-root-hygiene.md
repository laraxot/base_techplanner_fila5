...
git del monorepo (la forma con suffisso ha lo storico più lungo, da gennaio 2026; la
forma senza suffisso è comparsa dopo, luglio 2026). SSoT ora:
`bashscripts/ai/wiki/rules/module-theme-root-hygiene.md` sez. 2.
