...
- [Documentazione XotBaseResource](<nome repository>/laravel/modules/xot/docs/resource.md)
- [Best Practices Laraxot](<nome repository>/laravel/modules/xot/docs/best-practices.md)
