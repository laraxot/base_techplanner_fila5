...
- `laravel/folio`: Owner **Cms** (`Modules/Cms/composer.json`) — vedi [laravel-folio-module-dependency.md](../Cms/docs/wiki/concepts/laravel-folio-module-dependency.md)
- `livewire/volt`: Per componenti frontend (via Cms/Folio stack)
