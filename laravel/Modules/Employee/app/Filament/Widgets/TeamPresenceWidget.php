        ...
        return [
            Section::make(__('employee::widgets.team_presence.title'))
                ->schema([
                    ...
                    TextEntry::make('presence_stats')->content(fn () => $this->renderStatsDisplay($presenceData)),
                    TextEntry::make('presence_list')->content(fn () => $this->renderPresenceList($presenceData)),
                    Actions::make([
