---
title: "Code Quality Improvement Report — TestModule"
type: report
tags: [code-quality, phpstan, pest, maintainability]
module: "TestModule"
created: 2026-07-17
updated: 2026-07-17
qmd: "code quality baseline PHPStan Pest strict types Laraxot TestModule"
story: STORY-001
issues:
...
# Code Quality Improvement Report — TestModule
...
Dalla cartella laravel/:
    ...
    ./vendor/bin/phpstan analyse Modules/TestModule --memory-limit=-1
    ./vendor/bin/pest Modules/TestModule/tests
