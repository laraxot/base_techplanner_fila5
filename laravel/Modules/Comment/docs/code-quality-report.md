...
- Modules/Comment/app/Actions/Reaction/GetReactionCountsAction.php
- Modules/Comment/app/Actions/Comment/PrepareCommentForSavingAction.php

### Complessità / dimensione classi da rivedere

- Modules/Comment/app/Datas/CommentConfigData.php:31                                                TooManyPublicMethods      The class CommentConfigData has 13 public methods. Consider refactoring CommentConfigData to keep number of public methods under 10.
- Modules/Comment/app/Models/Comment.php:58                                                         TooManyPublicMethods      The class Comment has 26 public methods. Consider refactoring Comment to keep number of public methods under 10.
- Modules/Comment/packages/spatie/laravel-comments/src/Models/Comment.php:35                        TooManyPublicMethods      The class Comment has 27 public methods. Consider refactoring Comment to keep number of public methods under 10.
- Modules/Comment/packages/spatie/laravel-comments/src/Models/Comment.php:35                        ExcessiveClassComplexity  The class Comment has an overall complexity of 51 which is very high. The configured complexity threshold is 50.
- Modules/Comment/packages/spatie/laravel-comments/src/Support/Config.php:19                        TooManyPublicMethods      The class Config has 25 public methods. Consider refactoring Config to keep number of public methods under 10.
...
**Esempio concreto** — `Modules/Comment/app/Actions/Reaction/GetReactionCountsAction.php`:
