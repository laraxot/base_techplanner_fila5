---
title: "On-Demand Pattern — Module Comment"
type: documentation
created: 2026-05-11
updated: 2026-05-11
...
# On-Demand Pattern — Module **Comment**
...
| Ricerca locale | `qmd search "topic" -c Comment` |
| Wiki locale | `Read ./laravel/Modules/Comment/docs/wiki/index.md` |
...
3. **Mantieni la wiki aggiornata** — Dopo ogni task, aggiorna ./laravel/Modules/Comment/docs/wiki/log.md
