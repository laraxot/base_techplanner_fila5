---
title: "Composer root minimale — modulo Comment"
type: concept
tags: [composer, comment, nwidart, merge-plugin]
created: 2026-06-29
updated: 2026-06-29
qmd: "Comment composer dependencies root minimal nwidart merge-plugin"
issues:
...
# Comment e composer root minimale

## Regola

Dipendenze del dominio **Comment** in `Modules/Comment/composer.json`. Il root `laravel/composer.json` resta skeleton come [base_fixcity_fila5](https://github.com/laraxot/base_fixcity_fila5/blob/dev/laravel/composer.json).
