...
1. Pest: `cd laravel && ./vendor/bin/pest laravel/Modules/Comment/tests`
2. PHPStan: `cd laravel && ./vendor/bin/phpstan analyse laravel/Modules/Comment/tests --level=5`
3. PHPMD: `phpmd laravel/Modules/Comment/tests text phpmd.xml`
