---
title: "QMD Setup — Module Comment"
type: documentation
created: 2026-05-11
updated: 2026-05-11
...
paths:
  include:
    ...
    - ./laravel/Modules/Comment/docs/wiki/**/*.md  # ← Questo modulo
```
...
```bash
qmd search "<topic>" -c Comment
# Cerca solo in ./laravel/Modules/Comment/docs/wiki/
```
...
```bash
qmd search "form" -c Comment   # Solo questo modulo
```
...
| Ricerca lenta | Limita con `-c Comment` |
