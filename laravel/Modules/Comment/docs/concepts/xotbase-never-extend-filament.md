---
title: "Comment — mai Filament\*, sempre XotBase*"
type: concept
module: Comment
tags: [comment, filament, xotbase, architecture]
created: 2026-07-16
updated: 2026-07-16
qmd: "Comment filament never extend Filament class XotBase mirror path"
related:
...
Nessuna classe in `Modules/Comment` estende una classe `Filament\...` direttamente.
