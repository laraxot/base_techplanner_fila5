 ...
 * DatabaseTransactions via TestCase; connection activity; never RefreshDatabase.
 * Canon: Modules/Activity/docs/wiki/concepts/claude-audit-static.md
 * Model: Modules\Activity\Models\StoredEvent — event sourcing persistence.
 * claude-audit static documentation ratio gate for files >100 LOC.
 * Scope: empty/null properties, restore, timestamps, bulk import metadata.
 * Owner: Activity module — complements part 1 query/version tests.
 */
