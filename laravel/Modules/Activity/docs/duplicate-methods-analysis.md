...
Questo documento identifica i metodi duplicati nel modulo **Activity** che potrebbero beneficiare di refactoring.
...
- `extends::user` - [Modules/Activity/app/Models/Activity.php:97](Modules/Activity/app/Models/Activity.php)
...
- `ActivityLogger::login` - [Modules/Activity/app/Actions/ActivityLogger.php:86](Modules/Activity/app/Actions/ActivityLogger.php)
- `EsendexSendAction::login` - [Modules/Notify/app/Actions/EsendexSendAction.php:91](Modules/Notify/app/Actions/EsendexSendAction.php) (Modulo: Notify)
...
### 3. Metodo: `getStatistics`

**Tipo Refactoring**: `Interface` | **Complessità**: 🟢 Low | **Confidenza**: ⚠️ 50%

**Trovato in  file2 file**:

- `ActivityLogger::getStatistics` - [Modules/Activity/app/Actions/ActivityLogger.php:189](Modules/Activity/app/Actions/ActivityLogger.php)
- `TicketCacheService::getStatistics` - [Modules/Fixcity/app/Services/TicketCacheService.php:42](Modules/Fixcity/app/Services/TicketCacheService.php) (Modulo: Fixcity)
...
- `BaseModel::casts` - [Modules/Activity/app/Models/BaseModel.php:56](Modules/Activity/app/Models/BaseModel.php)
...
- `LogActivityAction::execute` - [Modules/Activity/app/Actions/LogActivityAction.php:31](Modules/Activity/app/Actions/LogActivityAction.php)
- `LogModelCreatedAction::execute` - [Modules/Activity/app/Actions/LogModelCreatedAction.php:28](Modules/Activity/app/Actions/LogModelCreatedAction.php)
- `LogModelDeletedAction::execute` - [Modules/Activity/app/Actions/LogModelDeletedAction.php:28](Modules/Activity/app/Actions/LogModelDeletedAction.php)
- `LogModelUpdatedAction::execute` - [Modules/Activity/app/Actions/LogModelUpdatedAction.php:28](Modules/Activity/app/Actions/LogModelUpdatedAction.php)
- `LogUserLoginAction::execute` - [Modules/Activity/app/Actions/LogUserLoginAction.php:26](Modules/Activity/app/Actions/LogUserLoginAction.php)
- `LogUserLogoutAction::execute` - [Modules/Activity/app/Actions/LogUserLogoutAction.php:26](Modules/Activity/app/Actions/LogUserLogoutAction.php)
