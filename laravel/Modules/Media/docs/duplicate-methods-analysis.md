...
Questo documento identifica i metodi duplicati nel modulo **Media** che potrebbero beneficiare di refactoring.
...
- `SubtitleService::make` - [Modules/Media/app/Services/SubtitleService.php:52](Modules/Media/app/Services/SubtitleService.php)
...
- `TextWidget::getContent` - [Modules/Blog/app/Models/TextWidget.php:97](Modules/Blog/app/Models/TextWidget.php) (Modulo: Blog)
- `SubtitleService::getContent` - [Modules/Media/app/Services/SubtitleService.php:122](Modules/Media/app/Services/SubtitleService.php)
...
- `SubtitleService::getInstance` - [Modules/Media/app/Services/SubtitleService.php:40](Modules/Media/app/Services/SubtitleService.php)
...
- `BaseModel::casts` - [Modules/Media/app/Models/BaseModel.php:61](Modules/Media/app/Models/BaseModel.php)
- `Media::casts` - [Modules/Media/app/Models/Media.php:340](Modules/Media/app/Models/Media.php)
...
### 5. Metodo: `registerMediaConversions`
...
- `TemporaryUpload::registerMediaConversions` - [Modules/Media/app/Models/TemporaryUpload.php:169](Modules/Media/app/Models/TemporaryUpload.php)
...
- `SubtitleService::get` - [Modules/Media/app/Services/SubtitleService.php:105](Modules/Media/app/Services/SubtitleService.php)
...
- `GetAttachmentsSchemaAction::execute` - [Modules/Media/app/Actions/GetAttachmentsSchemaAction.php:36](Modules/Media/app/Actions/GetAttachmentsSchemaAction.php)
- `SaveAttachmentsAction::execute` - [Modules/Media/app/Actions/SaveAttachmentsAction.php:17](Modules/Media/app/Actions/SaveAttachmentsAction.php)
