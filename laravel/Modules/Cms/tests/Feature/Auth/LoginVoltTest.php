...
<<<<<<< HEAD
    test('volt component tests require full setup', function (): void {
        \PHPUnit\Framework\Assert::markTestSkipped('Serve il componente Volt auth.login registrato dal tema: senza, non c\'e\' niente da montare.');
    });
=======
