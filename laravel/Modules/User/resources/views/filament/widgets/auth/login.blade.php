...
<div class="filament-widget-login space-y-8">
    ...
    <div class="text-center space-y-4">
        <div class="inline-flex items-center justify-center mb-2">
            <x-pub_theme::ui.logo class="h-14 w-auto sm:h-16" />
        </div>
        <div>
    ...
    <form wire:submit.prevent="save" class="space-y-5">
        ...
        @if (Route::has('password.request'))
            <div class="flex justify-end">
                <a href="{{ route('password.request') }}" class="text-sm text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 font-medium transition-colors duration-200">
