 ...
 *
 * @method static Builder<static>|TeamUser                         childrenWith(array<int, string> $relations)
 * @method static Builder<static>|TeamUser                         childrenWithCount(array<int, string> $relations)
