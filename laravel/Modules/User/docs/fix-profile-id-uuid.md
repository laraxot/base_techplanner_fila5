...
La migration `2026_02_22_000000_create_profiles_table.php` (unica per profiles) crea la tabella con id bigint + uuid e converte tabelle esistenti con id UUID se necessario.
