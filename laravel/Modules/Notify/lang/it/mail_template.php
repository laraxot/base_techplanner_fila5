...
return [
    'resource' => ['name' => 'Template Email', 'plural' => 'Template Email'],
    'navigation' => [
        'name' => 'Template Email',
    ...
    'actions' => [
        ...
        'duplicate' => ['label' => 'Duplica', 'tooltip' => 'Crea una copia del template', 'success_message' => 'Template duplicato con successo', 'error_message' => 'Errore nella duplicazione del template'],
        'export' => ['label' => 'Esporta', 'tooltip' => 'Esporta il template in formato JSON', 'success_message' => 'Template esportato con successo', 'error_message' => 'Errore nell\'esportazione del template'],
        'import' => ['label' => 'Importa', 'tooltip' => 'Importa un template da un file JSON', 'success_message' => 'Template importato con successo', 'error_message' => 'Errore nell\'importazione del template'],
        'activeLocale' => ['label' => 'activeLocale', 'icon' => 'activeLocale', 'tooltip' => 'activeLocale'],
        'create' => ['icon' => 'create', 'tooltip' => 'create', 'label' => 'create'],
        'createAnother' => ['label' => 'createAnother', 'icon' => 'createAnother', 'tooltip' => 'createAnother'],
        'delete' => ['icon' => 'delete', 'tooltip' => 'delete', 'label' => 'delete'],
        'save' => ['label' => 'save', 'icon' => 'save', 'tooltip' => 'save'],
        'view' => ['label' => 'view', 'icon' => 'view', 'tooltip' => 'view'],
        'edit' => ['icon' => 'edit', 'tooltip' => 'edit', 'label' => 'edit'],
