...
class WhatsAppData extends Data
{
     ...
     * @param  list<string>|null  $media  Array di URL di media da allegare al messaggio (immagini, video, documenti)
     * @param  list<array<string, mixed>>|null  $buttons  Array di pulsanti interattivi (supportati solo da alcuni provider)
     * @param  array<string, mixed>|null  $template  Dati del template per messaggi strutturati (supportati solo da alcuni provider)
