...
class TelegramData extends Data
{
     ...
     * @param  array<string, mixed>|null  $replyMarkup  Markup per tastiere inline, tastiere personalizzate, ecc.
     * @param  list<string>|null  $media  Array di media da allegare al messaggio (immagini, video, documenti)
