...
=======
                <p style="margin: 0; font-size: 16px; color: #334155;">{{ $location ?? 'Laraxot Centro Medico, Via Roma 123, 00100 Roma' }}</p>            </div>
>>>>>>> 8215f950 (.)
        </div>
...
=======
        <p style="margin: 10px 0 0; font-size: 14px; color: #64748b;">{{ $map_caption ?? 'Laraxot Centro Medico, Via Roma 123, 00100 Roma' }}</p>    </div>
>>>>>>> 8215f950 (.)
