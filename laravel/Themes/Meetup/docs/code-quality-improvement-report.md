---
title: "Code Quality Improvement Report — Meetup"
type: report
tags: [code-quality, phpstan, pest, maintainability]
module: "Meetup"
created: 2026-07-17
updated: 2026-07-17
qmd: "code quality baseline PHPStan Pest strict types Laraxot Meetup"
story: STORY-001
issues:
...
# Code Quality Improvement Report — Meetup
...
Dalla cartella laravel/:
    ...
    ./vendor/bin/phpstan analyse Themes/Meetup --memory-limit=-1
    ./vendor/bin/pest Themes/Meetup/tests
