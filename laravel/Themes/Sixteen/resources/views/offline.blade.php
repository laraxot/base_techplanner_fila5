...
<body class="offline-page">
    <div class="container-fluid vh-100 d-flex align-items-center justify-content-center">        <div class="row w-100">
>>>>>>> 8215f950 (.)
...
=======
        .offline-page {            background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%);
>>>>>>> 8215f950 (.)
