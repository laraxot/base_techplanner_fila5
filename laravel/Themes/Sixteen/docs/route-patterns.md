...
name('page_slug.view');
=======
// File: resources/views/pages/pages/[slug].blade.phpname('page_slug.view');
>>>>>>> 8215f950 (.)
...
=======
- [Route File](resources/views/pages/pages/[slug].blade.php)- [CMS Module](../../../laravel/Modules/Cms/)
>>>>>>> 8215f950 (.)
