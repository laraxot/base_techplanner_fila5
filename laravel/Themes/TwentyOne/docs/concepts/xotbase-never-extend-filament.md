---
title: "TwentyOne — mai Filament\*, sempre XotBase*"
type: concept
theme: TwentyOne
tags: [twentyone, filament, xotbase, architecture]
created: 2026-07-16
updated: 2026-07-16
qmd: "TwentyOne theme filament never extend Filament class XotBase mirror path"
related:
...
Nessuna classe nel tema `Themes/TwentyOne` estende una classe `Filament\...` direttamente.
