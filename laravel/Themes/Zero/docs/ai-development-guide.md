...
=======
- Use `<?php use function Livewire\Volt\{...}; ?>`- Keep logic minimal, delegate to actions
>>>>>>> 8215f950 (.)
...
=======
- [Filament v4 Themes](https://filamentphp.com/docs/4.x/themes)- [Tailwind CSS](https://tailwindcss.com/docs)
>>>>>>> 8215f950 (.)
