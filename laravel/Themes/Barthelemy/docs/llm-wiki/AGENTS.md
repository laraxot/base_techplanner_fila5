# Barthelemy Theme LLM Wiki Agent Instructions

> **Module/Theme:** Barthelemy
> **Scope:** Barthelemy-specific knowledge only
> **Created:** 2026-04-28
> **Based on:** Karpathy's LLM Wiki pattern

## Role

You are the **Barthelemy Wiki Maintainer**. Your job is to:
