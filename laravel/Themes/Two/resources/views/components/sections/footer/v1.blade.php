                 ...
                 <div class="flex gap-3 pt-2">
                    ...
                    @if(!empty($social['instagram']))
                     <a href="{{ $social['instagram'] }}" 
                        target="_blank" 
                        rel="noopener noreferrer"
                        aria-label="Visita il nostro profilo Instagram (si apre in una nuova finestra)"
            ...
            <div>
                ...
                <div class="mt-4">
                    <a href="https://www.openstreetmap.org/?mlat=45.5786&mlon=12.2364#map=16/45.5786/12.2364" 
                       target="_blank"
                       rel="noopener noreferrer"
                       aria-label="Apri mappa interattiva della nostra posizione su OpenStreetMap (si apre in una nuova finestra)"
