                ...
                @if(!empty($social))
                 <div class="flex gap-3 pt-2">
                     ...
                     <a href="{{ $social['linkedin'] }}" 
                        ...
                        aria-label="LinkedIn - Visita il nostro profilo (si apre in una nuova finestra)"
                    ...
                    @if(!empty($social['facebook']))
                     <a href="{{ $social['facebook'] }}" 
                        target="_blank" 
                        rel="noopener noreferrer"
                        aria-label="Facebook - Visita la nostra pagina (si apre in una nuova finestra)"
                    ...
                    @if(!empty($social['instagram']))
                     <a href="{{ $social['instagram'] }}" 
                        target="_blank" 
                        rel="noopener noreferrer"
                        aria-label="Instagram - Visita il nostro profilo (si apre in una nuova finestra)"
            ...
            <div>
                ...
                <div class="mt-4">
                    <a href="https://www.openstreetmap.org/?mlat=45.5786&mlon=12.2364#map=16/45.5786/12.2364" 
                       target="_blank"
                       rel="noopener noreferrer"
                       aria-label="Apri mappa: {{ $address }} (OpenStreetMap, si apre in nuova finestra)"
                       class="block w-full h-32 rounded-lg overflow-hidden border border-white/20 hover:border-white/40 transition-colors relative group focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-[#1E5A96]">
                        <span class="sr-only">Apri mappa della nostra sede su OpenStreetMap</span>
                        <iframe 
                            ...
                            title="Mappa posizione - Via Vanzo 86/A, 31021 Mogliano Veneto TV"
                            aria-label="Mappa interattiva della nostra posizione">
                        </iframe>
                        <div class="absolute inset-0 bg-black/20 group-hover:bg-black/0 transition-colors" aria-hidden="true"></div>
                    </a>
