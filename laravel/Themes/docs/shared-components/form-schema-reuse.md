...
## Widget FO (auth / wizard)

I widget Filament frontoffice **non** duplicano lo schema: delegano a `{Entity}Form` della Resource (es. `UserForm::getRegisterFormSchema()` da `RegisterWidget`). Vedi [filament-widget-resource-form-delegation](../../../../docs/wiki/decisions/filament-widget-resource-form-delegation.md).
